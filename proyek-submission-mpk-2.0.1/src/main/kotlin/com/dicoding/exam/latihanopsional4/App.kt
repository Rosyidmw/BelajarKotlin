...
fun getMiddleCharacters(string: String): String {
    val panjang = string.length

    if (panjang % 2 == 0) {
        val karakterTengah = string.substring(panjang / 2 - 1, panjang / 2 + 1)
        return karakterTengah
    }

    val nilaiTengah = string[panjang / 2]
    return nilaiTengah.toString()
}
